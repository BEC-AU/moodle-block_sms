...
class TiniyoAPI {
    ...
    public function __construct() {
        global $CFG;
        $this->authid = $CFG->block_sms_tiniyo_auth_id;
        $this->authtoken = $CFG->block_sms_tiniyo_auth_token;
        $this->fromnumber = $CFG->block_sms_tiniyo_api_from;
        $this->uri = 'https://api.tiniyo.com/v1/Account/'.$this->authid.'/Message';
    }
